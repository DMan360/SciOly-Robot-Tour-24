...
//Put Location of barriers 
//(T for barrier on top of block, B for barrier on bottom of block, L for barrier on left of Block, R for barrier on right of Block)
String maze[4][4] = {
  { "B", "B", "R", "L" },
  { "T", "T", "R", "L" },
  { "R", "L", "B", "B" },
...
//Maze starts from 0 and goes left to right and then up to down. On a 4x4 grid the range will be 0-15

int gateCount = 6;  //VERY IMPORTANT
int startNode = 15;
int G1 = 12;
int G2 = 0;
int G3 = 3;
...
int endPoints[] = { startNode, G1,G2,G3,G4,G5,G6, endNode }; // add gate zones in order that you want them to be achived

int endDistanceSubtraction = 13;
...
double leftAngleOffset = -14;
double rightAngleOffset = -14;
